...
<div v-loading="loading">
    ...
    <div v-else>
        <span class="fz12">{{nowuserid}}</span>
        <treeselect style="line-height: 35px;" :disable-branch-nodes="true" :value-consists-of="LEAF_PRIORITY" v-model="nowuserid" :multiple="false" :options="singleDeptTree" placeholder="请输入要切换人的姓名" />
        <el-button @click="changetouser(nowuserid)">切换</el-button>
    </div>
</div>
</template>
