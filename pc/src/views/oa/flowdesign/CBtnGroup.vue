...
export default {
    ...
    methods: {
        ...
        Editnewbtn(btn, index) {
            ...
            // if (nowbtn.defaultFunId) {
            //   nowbtn.defaultFunId = []
            // }
            // if (nowbtn.defaultSonFlowId) {
            //   nowbtn.defaultSonFlowId = []
            // }
            // if (nowbtn.handler.funId) {
            //   nowbtn.handler.funId = []
            // }
            // if (nowbtn.handler.SonFlowId) {
            //   nowbtn.handler.SonFlowId = []
            // }
            this.nowbtn = nowbtn
        },
