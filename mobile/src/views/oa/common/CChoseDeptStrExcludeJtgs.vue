...
<div>
    ...
    <div v-if="!disabled">
        ...
        <el-select style="width:100%" clearable filterable v-model="sync_value" :placeholder="placeholder">
        ...
        getdeptList(list, titiles = []) {
            ...
            for (let i = 0; i < list.length; i++) {
                ...
                if (ele.deptname) {  
                    ...
                    const newobj = {
                        label:
                        titileArr.filter(e=>{return e!='集团公司'}).join('-')
