...
export default {
    ...
    methods: {
        ...
        shaixuanRadioChanged() {
            localStorage.setItem('message.readstatus', this.search.readstatus == 'read' ? 'all' : this.search.readstatus);
            this.searchdata(1);
        },

        initsearch() {
            
            let readstatus = localStorage.getItem('message.readstatus');
        ...
        setReaded() {
            ...
            FlowSetRead({
                ...
                if (req.success) {
                    ...
                    this.flowBadge.message = this.flowBadge.message - req.data;
                    this.msgList.forEach(ele => {
